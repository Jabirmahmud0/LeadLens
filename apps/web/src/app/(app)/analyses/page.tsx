                ...
                <div className="group rounded-2xl border border-[#dce7df] bg-white p-5 shadow-[0_18px_48px_-42px_rgba(20,83,45,0.55)] transition-all hover:-translate-y-0.5 hover:border-[#bcd5c2] hover:shadow-sm">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    {a.status === 'completed' ? (
                      ...
                      <a 
                        href={`/analyses/${a.id}`}
                        className="flex items-center gap-1.5 px-4 py-2 border border-neutral-600 bg-transparent text-neutral-300 hover:border-neutral-400 hover:text-white rounded-xl text-[12px] font-bold transition-all shrink-0"
                      >
                        View Status
                      </a>
                    )}
