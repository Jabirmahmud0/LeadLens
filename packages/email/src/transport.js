...
function getTransport() {
    ...
    var host = process.env.SMTP_HOST || 'smtp-relay.brevo.com';
...
function sendEmail(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            from = options.from || process.env.SMTP_FROM || '"LeadLens" <hello@leadlens.com>';
            return [2 /*return*/, transport.sendMail({
                    from: from,
                    to: options.to,
